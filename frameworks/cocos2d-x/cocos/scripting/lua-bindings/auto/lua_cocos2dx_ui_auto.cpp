...
int lua_cocos2dx_ui_ImageView_loadTexture(lua_State* tolua_S)
{
    ...
    do{
        if (argc == 1) {
            ...
            ok &= luaval_to_object<cocos2d::Texture2D>(tolua_S, 2, "cc.Texture2D",&arg0, "ccui.ImageView:loadTexture");
...
int lua_cocos2dx_ui_ImageView_getTexture(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::ImageView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_ImageView_getTexture'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_ImageView_getTexture'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.ImageView:getTexture",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_ImageView_getTexture'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_ImageView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"ImageView");
        ...
        tolua_function(tolua_S,"getTexture",lua_cocos2dx_ui_ImageView_getTexture);
...
int lua_cocos2dx_ui_Slider_getProgressBarRenderer(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Slider* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Slider_getProgressBarRenderer'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Slider_getProgressBarRenderer'", nullptr);
            return 0;
        }
        cocos2d::Node* ret = cobj->getProgressBarRenderer();
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Slider:getProgressBarRenderer",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Slider_getProgressBarRenderer'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_Slider_getSlidBallTexturePressed(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Slider* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Slider_getSlidBallTexturePressed'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Slider_getSlidBallTexturePressed'", nullptr);
            return 0;
        }
        cocos2d::Node* ret = cobj->getSlidBallTexturePressed();
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Slider:getSlidBallTexturePressed",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Slider_getSlidBallTexturePressed'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_Slider_getSlidBallRenderer(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Slider* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Slider_getSlidBallRenderer'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Slider_getSlidBallRenderer'", nullptr);
            return 0;
        }
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Slider:getSlidBallRenderer",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Slider_getSlidBallRenderer'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_Slider_getSlidBallTextureDisabled(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Slider* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Slider_getSlidBallTextureDisabled'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Slider_getSlidBallTextureDisabled'", nullptr);
            return 0;
        }
        cocos2d::Node* ret = cobj->getSlidBallTextureDisabled();
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Slider:getSlidBallTextureDisabled",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Slider_getSlidBallTextureDisabled'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_Slider_getSlidBallTextureNormal(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Slider* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Slider_getSlidBallTextureNormal'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_Slider_getSlidBallTextureNormal'", nullptr);
            return 0;
        }
        cocos2d::Node* ret = cobj->getSlidBallTextureNormal();
        object_to_luaval<cocos2d::Node>(tolua_S, "cc.Node",(cocos2d::Node*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.Slider:getSlidBallTextureNormal",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Slider_getSlidBallTextureNormal'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Slider(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Slider");
        ...
        tolua_function(tolua_S,"getProgressBarRenderer",lua_cocos2dx_ui_Slider_getProgressBarRenderer);
        ...
        tolua_function(tolua_S,"getSlidBallTexturePressed",lua_cocos2dx_ui_Slider_getSlidBallTexturePressed);
        ...
        tolua_function(tolua_S,"getSlidBallRenderer",lua_cocos2dx_ui_Slider_getSlidBallRenderer);
        tolua_function(tolua_S,"addEventListener",lua_cocos2dx_ui_Slider_addEventListener);
        tolua_function(tolua_S,"getSlidBallTextureDisabled",lua_cocos2dx_ui_Slider_getSlidBallTextureDisabled);
        ...
        tolua_function(tolua_S,"getSlidBallTextureNormal",lua_cocos2dx_ui_Slider_getSlidBallTextureNormal);
...
int lua_cocos2dx_ui_PageView_setIsTouchFull(lua_State* tolua_S)
{
    int argc = 0;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_PageView_setIsTouchFull'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccui.PageView:setIsTouchFull");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_PageView_setIsTouchFull'", nullptr);
            return 0;
        }
        cobj->setIsTouchFull(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.PageView:setIsTouchFull",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_PageView_setIsTouchFull'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_PageView_setIsContinuous(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::PageView* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_PageView_setIsContinuous'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_boolean(tolua_S, 2,&arg0, "ccui.PageView:setIsContinuous");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_PageView_setIsContinuous'", nullptr);
            return 0;
        }
        cobj->setIsContinuous(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.PageView:setIsContinuous",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_PageView_setIsContinuous'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_PageView(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"PageView");
        ...
        tolua_function(tolua_S,"setIsTouchFull",lua_cocos2dx_ui_PageView_setIsTouchFull);
        ...
        tolua_function(tolua_S,"setIsContinuous",lua_cocos2dx_ui_PageView_setIsContinuous);
...
int lua_cocos2dx_ui_RichElementNewLine_init(lua_State* tolua_S)
{
    int argc = 0;
...
#if COCOS2D_DEBUG >= 1
    if (!tolua_isusertype(tolua_S,1,"ccui.RichElementNewLine",0,&tolua_err)) goto tolua_lerror;
#endif

    cobj = (cocos2d::ui::RichElementNewLine*)tolua_tousertype(tolua_S,1,0);

#if COCOS2D_DEBUG >= 1
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichElementNewLine_init'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_int32(tolua_S, 2,(int *)&arg0, "ccui.RichElementNewLine:init");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichElementNewLine_init'", nullptr);
            return 0;
        }
        bool ret = cobj->init(arg0);
        tolua_pushboolean(tolua_S,(bool)ret);
    ...
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichElementNewLine:init",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichElementNewLine_init'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_RichElementNewLine_create(lua_State* tolua_S)
{
    ...
    if (argc == 1)
    {
        ...
        cocos2d::ui::RichElementNewLine* ret = cocos2d::ui::RichElementNewLine::create(arg0);
        object_to_luaval<cocos2d::ui::RichElementNewLine>(tolua_S, "ccui.RichElementNewLine",(cocos2d::ui::RichElementNewLine*)ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d\n ", "ccui.RichElementNewLine:create",argc, 1);
    return 0;
#if COCOS2D_DEBUG >= 1
    tolua_lerror:
...
int lua_register_cocos2dx_ui_RichElementNewLine(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"RichElementNewLine");
        ...
        tolua_function(tolua_S,"init",lua_cocos2dx_ui_RichElementNewLine_init);
...
int lua_cocos2dx_ui_RichText_setRenderSize(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichText_setRenderSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 1) 
    {
        ...
        ok &= luaval_to_size(tolua_S, 2, &arg0, "ccui.RichText:setRenderSize");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichText_setRenderSize'", nullptr);
            return 0;
        }
        cobj->setRenderSize(arg0);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichText:setRenderSize",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichText_setRenderSize'.",&tolua_err);
#endif
...
int lua_cocos2dx_ui_RichText_getRenderSize(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::RichText* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_RichText_getRenderSize'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 0) 
    {
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_RichText_getRenderSize'", nullptr);
            return 0;
        }
        cocos2d::Size ret = cobj->getRenderSize();
        size_to_luaval(tolua_S, ret);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.RichText:getRenderSize",argc, 0);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_RichText_getRenderSize'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_RichText(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"RichText");
        ...
        tolua_function(tolua_S,"setRenderSize",lua_cocos2dx_ui_RichText_setRenderSize);
        ...
        tolua_function(tolua_S,"getRenderSize",lua_cocos2dx_ui_RichText_getRenderSize);
...
int lua_cocos2dx_ui_Scale9Sprite_initWithTexture(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::Scale9Sprite* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj)
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_Scale9Sprite_initWithTexture'", nullptr);
        return 0;
    }
#endif
    argc = lua_gettop(tolua_S)-1;
    do{
        if (argc == 2) {
            cocos2d::Texture2D* arg0;
            ok &= luaval_to_object<cocos2d::Texture2D>(tolua_S, 2, "cc.Texture2D",&arg0, "ccui.Scale9Sprite:initWithTexture");

            if (!ok) { break; }
            cocos2d::Rect arg1;
            ok &= luaval_to_rect(tolua_S, 3, &arg1, "ccui.Scale9Sprite:initWithTexture");
    ...
    do{
        if (argc == 3) {
            ...
            if (!ok) { break; }
            cocos2d::Rect arg2;
            ok &= luaval_to_rect(tolua_S, 4, &arg2, "ccui.Scale9Sprite:initWithTexture");
    ...
    do{
        if (argc == 2) {
            cocos2d::Rect arg0;
            ok &= luaval_to_rect(tolua_S, 2, &arg0, "ccui.Scale9Sprite:initWithTexture");

            if (!ok) { break; }
            cocos2d::Texture2D* arg1;
            ok &= luaval_to_object<cocos2d::Texture2D>(tolua_S, 3, "cc.Texture2D",&arg1, "ccui.Scale9Sprite:initWithTexture");
    ...
    ok  = true;
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n",  "ccui.Scale9Sprite:initWithTexture",argc, 1);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_Scale9Sprite_initWithTexture'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_Scale9Sprite(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"Scale9Sprite");
        ...
        tolua_function(tolua_S,"initWithTexture",lua_cocos2dx_ui_Scale9Sprite_initWithTexture);
...
int lua_cocos2dx_ui_EditBox_setImplContentSizeScale(lua_State* tolua_S)
{
    int argc = 0;
    cocos2d::ui::EditBox* cobj = nullptr;
    bool ok  = true;
    ...
    if (!cobj) 
    {
        tolua_error(tolua_S,"invalid 'cobj' in function 'lua_cocos2dx_ui_EditBox_setImplContentSizeScale'", nullptr);
        return 0;
    }
#endif
    ...
    if (argc == 2) 
    {
        ...
        ok &= luaval_to_number(tolua_S, 2,&arg0, "ccui.EditBox:setImplContentSizeScale");

        ok &= luaval_to_number(tolua_S, 3,&arg1, "ccui.EditBox:setImplContentSizeScale");
        if(!ok)
        {
            tolua_error(tolua_S,"invalid arguments in function 'lua_cocos2dx_ui_EditBox_setImplContentSizeScale'", nullptr);
            return 0;
        }
        cobj->setImplContentSizeScale(arg0, arg1);
        lua_settop(tolua_S, 1);
        return 1;
    }
    luaL_error(tolua_S, "%s has wrong number of arguments: %d, was expecting %d \n", "ccui.EditBox:setImplContentSizeScale",argc, 2);
    return 0;

#if COCOS2D_DEBUG >= 1
    tolua_lerror:
    tolua_error(tolua_S,"#ferror in function 'lua_cocos2dx_ui_EditBox_setImplContentSizeScale'.",&tolua_err);
#endif
...
int lua_register_cocos2dx_ui_EditBox(lua_State* tolua_S)
{
    ...
    tolua_beginmodule(tolua_S,"EditBox");
        ...
        tolua_function(tolua_S,"setImplContentSizeScale",lua_cocos2dx_ui_EditBox_setImplContentSizeScale);
