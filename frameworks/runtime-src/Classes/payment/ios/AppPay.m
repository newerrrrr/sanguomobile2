...
#define NOTIFY_SERVER "http://27.115.98.172:9998/payment/appleNotifyReceiver"

static AppPay* _sharedInstance=nil;
...
+(void) purchase:(NSDictionary *)dictionary
{
    ...
    AppPay* instance=[AppPay sharedInstance];
    ...
    if (![instance isPaying])
    {
        ...
        [instance purchaseByOrderId:orderId AndProductId:productId];
    }
    else
    {
...
-(void) requestProduct:(NSString *)productId
{
    ...
    else
    {
        ...
        NSString *title=NSLocalizedString(@"purchase_tips",nil);
        
        NSString *message=NSLocalizedString(@"purchase_bank_error",nil);
        
        NSString *cancelText=NSLocalizedString(@"purchase_close",nil);
...
-(void) productsRequest:(SKProductsRequest *)request didReceiveResponse:(SKProductsResponse *)response
{
    ...
    else
    {
        ...
        NSString *message=NSLocalizedString(@"purchase_no_product_error",nil);
...
- (void) failedTransaction: (SKPaymentTransaction *)transaction
{
    ...
    NSString *message=NSLocalizedString(@"purchase_failed",nil);
...
-(BOOL)syncNotifyServerOrderId:(NSString*)orderId AndReceiptData:(NSString*)receiptData
{
    ...
    NSString *notifyUrl=[NSString stringWithUTF8String:NOTIFY_SERVER];
...
+(void) clearResource
{
    if(_sharedInstance!=nil)
    {
        ...
        //[[_sharedInstance controller]release];
        [[_sharedInstance receiveData]release];
    }
}
@end
