...
public class IabHelper {
    ...
    //使用in app billing的版本号
    static final int APIVERSION=3;
     ...
     */
    public IabHelper(Context ctx,Activity mActivity, String base64PublicKey) {
    ...
    public void startSetup(final OnIabSetupFinishedListener listener) {
        try {
          ...
          mServiceConn = new BillServiceConnection(listener); 
          final Intent serviceIntent = new Intent("com.android.vending.billing.InAppBillingService.BIND");
          serviceIntent.setPackage("com.android.vending");
          List<ResolveInfo> res=mContext.getPackageManager().queryIntentServices(serviceIntent, 0);
    ...
    private final class BillServiceConnection implements ServiceConnection {

      private OnIabSetupFinishedListener listener;

      public BillServiceConnection(OnIabSetupFinishedListener listener) {
