...
local MapArrayMD = require "game.mapguildwar.worldMapLayer_mapArray"
...
function create(areaIndex)
	...
	local tmxLayer = lhs.LHSTmxLayer:create(string.format("worldmap/mapRes/map_ss%d.tmx",MapArrayMD.map[areaIndex.y + 1][areaIndex.x + 1]))
	m_Root = tmxLayer
