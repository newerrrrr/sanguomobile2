...
function create_Throw(general_original_id, place_type)
	local function onAttackStart(targetBuildServerData)
		...
		require("game.mapguildwar.worldMapLayer_bigMap").addAutoEffect(sp, HelperMD.bigTileIndex_2_tileZOrder(cc.p(targetBuildServerData.x,targetBuildServerData.y)))
	end
