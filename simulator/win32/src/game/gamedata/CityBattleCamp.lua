--g_cityBattleCamp
local CityBattleCamp = {}
setmetatable(CityBattleCamp,{__index = _G})
setfenv(1, CityBattleCamp)

local baseData = nil

--更新显示
function NotificationUpdateShow()
	require("game.mapcitybattle.worldMapLayer_uiLayer").showPassiveSkillIcon() 
end
