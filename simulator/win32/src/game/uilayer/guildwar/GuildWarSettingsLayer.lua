...
function GuildWarSettingsLayer:ctor()
	...
	self._baseNode:getChildByName("content_popup"):getChildByName("Text_1"):setString(g_tr("guild_war_settings_item1"))
    ...
    g_msgBox.show(g_tr("guild_war_exit_tip"),nil,nil,alertCallBack,1)
	end)
